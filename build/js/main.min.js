...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var videoEl = document.querySelectorAll('video')[0];
  var playBtn = document.querySelector('.gym__video-button');
  var vidControls = document.querySelector('.gym__video-controls');
  playBtn.style.backgroundImage = 'url(../img/video_button.svg)'; // если браузер может воспроизводить видео удаляем класс

  videoEl.addEventListener('canplaythrough', function () {
    vidControls.classList.remove('visually-hidden');
  }, false); // запускам или останавливаем воспроизведение
    ...
    _createClass(ItcTabs, [{
      ...
      value: function _init() {
        ...
        this._elButtons.forEach(function (el, index) {
          ...
          _this._elPanels[index].setAttribute('role', 'tabpanel');
        });
      }
    }, {
      key: "show",
      value: function show(elLinkTarget) {
        var elPaneTarget = this._elPanels[elLinkTarget.dataset.index];

        var elLinkActive = this._elTabs.querySelector('.season-tickets__tabs-button--active');

        var elPanelShow = this._elTabs.querySelector('.season-tickets__tabs-panel--show');
      ...
      value: function _events() {
        ...
        this._elTabs.addEventListener('click', function (e) {
          var target = e.target.closest('.season-tickets__tabs-button');
  ...
  new ItcTabs('.season-tickets__tabs'); // Slider
